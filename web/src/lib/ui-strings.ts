...
export const UI = {
  ...
  kk: {
    ...
    contact: "Байланыс",
    readMore: "Толығырақ",
    contactHeading: "Бізбен байланысыңыз",
    formName: "Атыңыз",
    formPhone: "Телефоныңыз",
    formMessage: "Хабарлама (міндетті емес)",
    formSubmit: "Жіберу",
    formThanks: "Рахмет! Жақын арада сізбен байланысамыз.",
    formError: "Жіберілмеді. Қайталап көріңіз.",
    adminTitle: "Сайтты басқару",
    postKindNews: "Жаңалық",
    postKindAchievement: "Жетістік",
    postKindAnnouncement: "Хабарландыру",
    fieldTitle: "Тақырып",
    fieldBody: "Мәтін",
    publish: "Жариялау",
    remove: "Жою",
    publishedOk: "Жарияланды! Сайт жаңартылды.",
    translationsPending: "Аудармалар кейінірек автоматты түрде қосылады.",
